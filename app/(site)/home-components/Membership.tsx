                        ...
                        <div className="flex flex-col gap-6 flex-1">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 text-sm">Over US$40,000 is available each year across three different scholarship opportunities. Most winners receive US$1,000.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="size-2 rounded-full bg-ieeeBlue mt-2 shrink-0"></div>
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 text-sm">Access to a real network (students, alumni, professionals) + referrals happen through people.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="size-2 rounded-full bg-ieeeBlue mt-2 shrink-0"></div>
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 text-sm">Reduced rates for IEEE/IEEE CS conferences (and sometimes local events).</p>
                                </div>
                            </div>
                        </div>
                        
                        <div className="flex flex-col items-center justify-center bg-white dark:bg-gray-800 rounded-xl shadow-md px-8 py-8 border border-gray-200 dark:border-gray-700">
                            <span className="text-gray-500 dark:text-gray-400 text-sm uppercase tracking-wide mb-1">Annual Student Membership</span>
                            <span className="text-7xl font-bold text-ieeeBlue">$40</span>
                            <span className="text-gray-500 dark:text-gray-400 text-sm mt-1">per year</span>
                            <a 
