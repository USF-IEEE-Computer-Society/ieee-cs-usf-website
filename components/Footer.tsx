                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flex flex-row gap-10 items-center justify-center">
                        ...
                        <div className="flex flex-row gap-5">
                            <a href="https://www.instagram.com/ieeecs_usf" target="_blank" rel="noopener noreferrer">
                                <InstagramIcon />
                            </a>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <h1 className="text-center">© 2026 IEEE Computer Society at USF.</h1>
                        <h1 className="text-center">All rights reserved. No commercial use without permission.</h1>
                    </div>
